package de.kleindev.discord.supportbot.logging;

import de.kleindev.discord.supportbot.SupportBot;
import de.kleindev.discord.supportbot.events.application.SupportBotFatalLogEvent;
import de.kleindev.discord.supportbot.objects.DiscardingQueue;
import de.kleindev.discord.supportbot.utils.StackTraceHelper;
...
public class Logger {
    ...
    private static void __log(LogType logType, String message, boolean print) {
        ...
        if (logType == LogType.INFO) {
            ...
            SupportBot.getInstance().getEventManager().callEvent(new SupportBotFatalLogEvent(message));
