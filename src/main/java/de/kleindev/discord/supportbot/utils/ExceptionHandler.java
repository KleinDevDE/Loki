...
import de.kleindev.discord.supportbot.Main;
...
public class ExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    public static void handle(Throwable e){
        ...
        e.printStackTrace();
        if (SupportBot.getInstance() != null && SupportBot.getInstance().getDiscordApi() != null) {
            ...
            SupportBot.getInstance().getDiscordApi().getUserById(221313993321480192L).join().sendMessage(embedBuilder);
        }
